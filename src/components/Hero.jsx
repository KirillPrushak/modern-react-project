...
import { fadeIn, textVariant } from '../ultils/motions';
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
         ...
         hover:bg-gray-100 transition-colors cursor-pointer group"
          >
            <span className="text-blue-600 group-hover:text-amber-300 group-hover:scale-140 transition-transform">
              ★
            </span>
      ...
      >
        <div className="relative">
          <img
            src={heroImage}
            alt="Hero image"
            className="rounded-lg relative z-10 hover:scale-[1.02] transition-transform decoration-300"
          />
        </div>
      </motion.div>
    </section>
