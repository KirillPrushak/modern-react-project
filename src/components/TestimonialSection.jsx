    ...
    <section className="py-16 px-4 max-w-7xl mx-auto" id="testimonials">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold md:text-4xl mb-4">
          Watch our happy client say
        </h2>
        <p className="text-gray-600">
          Thing that make it the best place to start trading
        </p>
      </div>
      ...
      <div className="relative">
        ...
        >
          {testimonials.map((testimonial, index) => (
            <SwiperSlide key={index} className="h-full md:py-12 py-4">
              <div
                className="text-center bg-white p-4 rounded-lg shadow-md h-full
              flex flex-col"
              >
        ...
        <div className="flex justify-center gap-4 md:mt-8 mt-4">
          <button
            className="swiper-button-prev-custom w-12 h-12 rounded-full border border-gray-200 
          ...
          <button
            className="swiper-button-next-custom w-12 h-12 rounded-full border border-gray-200 
          flex items-center justify-center hover:bg-blue-500 hover:text-white
          transition-all duration-200 cursor-pointer"
          >
