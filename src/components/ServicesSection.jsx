      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
        ...
        <div className="md:w-1/3 w-full">
          ...
          <p className="text-gray-600 text-lg mb-4 md:w-4/5">
            Discuss your goals, determine seccess metrics, identify problems
          </p>
          ...
          <button
            className="mt-8 bg-indigo-600 text-white px-8 py-3 cursor-pointer 
          rounded-full hover:bg-indigo-700 transition-colors"
          >
            Get Started
          </button>
        </div>
