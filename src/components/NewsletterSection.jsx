...
function NewsletterSection() {
  return (
    <section className="container ma-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-blue-600 rounded-2xl overflow-hidden">
        <div className="relative md:px-16 py-16 px-6 md:py-24">
          {/* gradient bg */}
          <div
            className="absolute top-0 right-0 w-1/2 h-full bg-blue-700
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-0">
              <input
                ...
                className="w-full bg-white sm:w-auto md:w-80 px-4 sm:px-6 py-3 sm:py-4 rounded-xl
              ...
              sm:px-8 py-3 sm:py-4 rounded-xl rounded-l-none sm:rounded-r-lg flex items-center gap-2"
              >
                <span>Discover</span>
